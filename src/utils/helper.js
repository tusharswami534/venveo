...
export const SATISFIED_LIST = [{
        Background: "bg-amber-book",
        heading: "Education Company",
        logo: < AmberIcon / > ,
        title: "Driving digital revenue for over 1,000+ satisfied clients.",
...
export const MARKETING_LIST = [{
        logo: < FourCircle / > ,
        heading: "My website isn’t getting enough traffic",
    ...
    {
        logo: < MyCpl / > ,
        heading: "My CPL from digital ad campaigns is too high",
        description: "Without consistent site traffic, you’re missing out on valuable visitors, leads, and revenue. Thankfully, custom SEO solutions can get you back on track by boosting your presence in search engine results, so more people can find and visit your site.",
    ...
    {
        logo: < Generating / > ,
        heading: "My website isn’t generating enough leads",
    ...
    {
        logo: < Marketing / > ,
        heading: "My marketing and sales data is disconnected",
