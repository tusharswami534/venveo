...
const Hero = () => {
  return (
    <div style={{ backgroundImage: "url('./assets/images/png/hero-bg-image.png')" }} className="relative bg-set bg-no-repeat max-md:bg-set-md max-lg:px-5">
      ...
      <img className="absolute w-full bottom-[25%] 2xl:bottom-[20%]" src="./assets/images/webp/hero-line.webp" alt="" />
      <div className="py-20 max-lg:py-16 max-md:py-12 max-sm:py-10">
        ...
        <img className="max-w-[256px] absolute left-[8%] max-sm:max-w-[146px] max-[400px]:left-[13%]" src="./assets/images/webp/text-line.webp" alt="text-line" /></span> machine</h1>
        </div>
